...
object PublicDeployment : BuildType({
    ...
    steps {
        ...
        powerShell {
            ...
            noProfile = false
            scriptArgs = "-Script Build.ps1 -ImageName metalamasamples-2026.1 -NoBuildImage -Label %system.teamcity.buildType.id%_%build.number% publish --configuration Public --deployment default --timeout %Publish.Timeout% %Publish.Arguments%"
        }
        powerShell {
            name = "Cleanup Docker containers"
            id = "DockerCleanup"
